...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_ESC,  KC_LEAD,  KC_LGUI,  KC_LSFT,      KC_BSPC,  KC_LCTL,      KC_LALT,      KC_SPC,       OSL(1),       KC_TAB,   KC_DEL,  KC_ENT
  ),
  [1] = LAYOUT(
    ...
    KC_ESC,   KC_LEAD,  KC_LGUI,  KC_LSFT,  KC_BSPC,  KC_LCTL,      KC_LALT,      KC_DEL,   KC_NO,  KC_0,   KC_DOT,  KC_ENT
  ),
  [2] = LAYOUT(
    ...
    RESET,   KC_LEAD,  KC_LGUI,  KC_LSFT,  KC_BSPC,  KC_LCTL,      KC_LALT,      KC_DEL,   TO_0,     KC_TAB,   KC_DEL,   KC_ENT
 ),
  [3] = LAYOUT(
